		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="calendar.jsp"><i class="glyphicon glyphicon-calendar"></i> Calendar</a></li>
                    <li><a href="stats.jsp"><i class="glyphicon glyphicon-stats"></i> Statistics (Charts)</a></li>
                    <li><a href="tables.jsp"><i class="glyphicon glyphicon-list"></i> Tables</a></li>
                    <li class="current"><a href="buttons.jsp"><i class="glyphicon glyphicon-record"></i> Buttons</a></li>
                    <li><a href="editors.jsp"><i class="glyphicon glyphicon-pencil"></i> Editors</a></li>
                    <li><a href="forms.jsp"><i class="glyphicon glyphicon-tasks"></i> Forms</a></li>
                    <li class="submenu">
                         <a href="#">
